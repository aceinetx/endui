 ...
 */
LM_API lm_size_t LM_CALL LM_ReadMemory(lm_address_t source, lm_byte_t *dest,
                                       lm_size_t size);
...
LM_API lm_size_t LM_CALL LM_ReadMemoryEx(const lm_process_t *process,
                                         lm_address_t source, lm_byte_t *dest,
                                         lm_size_t size);
...
LM_API lm_size_t LM_CALL LM_WriteMemory(lm_address_t dest,
                                        lm_bytearray_t source, lm_size_t size);
 ...
 * `dest`.
 */
LM_API lm_size_t LM_CALL LM_SetMemory(lm_address_t dest, lm_byte_t byte,
                                      lm_size_t size);
...
LM_API lm_size_t LM_CALL LM_SetMemoryEx(const lm_process_t *process,
                                        lm_address_t dest, lm_byte_t byte,
                                        lm_size_t size);
 ...
 */
LM_API lm_bool_t LM_CALL LM_ProtMemory(lm_address_t address, lm_size_t size,
                                       lm_prot_t prot, lm_prot_t *oldprot_out);
...
LM_API lm_bool_t LM_CALL LM_ProtMemoryEx(const lm_process_t *process,
                                         lm_address_t address, lm_size_t size,
                                         lm_prot_t prot,
...
LM_API lm_bool_t LM_CALL LM_FreeMemoryEx(const lm_process_t *process,
                                         lm_address_t alloc, lm_size_t size);
 ...
 * `LM_ADDRESS_BAD`.
 */
LM_API lm_address_t LM_CALL LM_DataScan(lm_bytearray_t data, lm_size_t datasize,
                                        lm_address_t address,
                                        lm_size_t scansize);
 ...
 */
LM_API lm_size_t LM_CALL LM_AssembleEx(lm_string_t code, lm_arch_t arch,
...
LM_API lm_size_t LM_CALL LM_DisassembleEx(lm_address_t machine_code,
                                          lm_arch_t arch, lm_size_t max_size,
 ...
 * instruction).
 */
LM_API lm_size_t LM_CALL LM_HookCode(lm_address_t from, lm_address_t to,
...
LM_API lm_size_t LM_CALL LM_HookCodeEx(const lm_process_t *process,
                                       lm_address_t from, lm_address_t to,
                                       lm_address_t *trampoline_out);
...
LM_API lm_bool_t LM_CALL LM_UnhookCode(lm_address_t from,
                                       lm_address_t trampoline, lm_size_t size);
 ...
 * @return On success, it returns `LM_TRUE`. On failure, it returns `LM_FALSE`.
 */
LM_API lm_bool_t LM_CALL LM_VmtHook(lm_vmt_t *vmt, lm_size_t from_fn_index,
                                    lm_address_t to);
